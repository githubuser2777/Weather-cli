...
## v1.0.0.b - Weather CLI MVP (2026-05-28)

- 4 phases completed
- Core features delivered: IP geolocation, weather fetching, colored ASCII widget, configuration persistence, Nerd Font icons, and multi-day forecasting.
